...
const GPTSearchBar = () => {
    ...
    const handleGptSearchClick=async ()=>{
        ...
        try {
            ...
            console.log("GPT Response:", gptResults);

            const gptMovies=gptResults?.choice[0]?.message?.content.spli(",")
  ...
  return (
    <div>
         <div className="pt-[35%] md:pt-[10%] flex justify-center rounded-2xl">
      <form
